...
#ifeq ($(SYSTYPE),"HPC3")
#CC       = mpicc -lhdf5 -lz #mpicc
#CXX 	 = mpic++ 
#FC	 = mpif90
#OPTIMIZE = -O3 -funroll-loops #fast=2 #speed
#OPTIMIZE += -O3 -Wall -DPERIODIC -DUNEQUALSOFTENINGS -DPEANOHILBERT -DWALLCLOCK -DSYNCHRONIZATION -DHAVE_DHF5 -DH5_USE_16_API # compiler warnings
#OPTIMIZE = -O3  -DH5_USE_16_API -USE_FFTW3
...
#MKL_INCL = #
#MKL_LIBS = #
#GSL_INCL = -I$(GSL_HOME)/include #/opt/apps/gsl/2.6/gcc/8.4.0/include/gsl
#GSL_LIBS = -L$(GSL_HOME)/lib   #/opt/apps/gsl/2.6/gcc/8.4.0/lib
#FFTW_INCL= -I$(FFTW_DIR)/include  #/opt/apps/fftw/3.3.8/gcc/8.4.0/include
#FFTW_LIBS= -L$(FFTW_DIR)/lib  #/opt/apps/fftw/3.3.8/gcc/8.4.0/lib
#HDF5_INCL= -I/opt/apps/hdf5/1.10.5/intel/2020u1/include/ -DH5_USE_16_API
#HDF5_INCL= -I$(HDF5_HOME)/include -DH5_USE_16_API  #/opt/apps/hdf5/1.10.5/gcc/8.4.0/include -DH5_USE_16_API
#HDF5LIB= -L$(HDF5_HOME)/lib -lhdf5 -lz  #/opt/apps/hdf5/1.10.5/gcc/8.4.0/lib -lhdf5 -lz
#MPICHLIB = #
#HDF5_LIBS= -L/opt/apps/hdf5/1.10.5/intel/2020u1/lib/ -lhdf5 -lz
#OPT     += -DUSE_MPI_IN_PLACE -USE_FFTW3
#endif

ifeq ($(SYSTYPE),"HPC3")
        CC        = gcc
        CXX       = g++ 
        OPTIMIZE  = -O3 #-parallel -openmp
ifeq (OPENMP,$(findstring OPENMP,$(CONFIGVARS)))
OPTIMIZE += -openmp -Wall # openmp required compiler flags                                                                                                                                
endif
        GSL_INCL  = -I/opt/apps/gsl/2.7.1/gcc/11.2.0/include  #2.6, 8.4.0
        GSL_LIBS  = -L/opt/apps/gsl/2.7.1/gcc/11.2.0/lib
        FFTW_INCL = -I/opt/apps/fftw/3.3.10/gcc/11.2.0/openmpi/4.1.2/include  #3.3.8, 8.4.0, 4.0.3
        FFTW_LIBS = -L/opt/apps/fftw/3.3.10/gcc/11.2.0/openmpi/4.1.2/lib
        HDF5INCL  = -I/opt/apps/hdf5/1.13.1/gcc/11.2.0/openmpi/4.1.2/include -DH5_USE_16_API   #I/opt/apps/hdf5/1.10.5/gcc/8.4.0/include
        HDF5LIB   = -L/opt/apps/hdf5/1.13.1/gcc/11.2.0/openmpi/4.1.2/lib -lhdf5 -lz	        #L/opt/apps/hdf5/1.10.5/gcc/8.4.0/lib
        MPICHLIB  =
endif
