...
HAVE_HDF5
#DEBUG
#MERGESPLIT_HARDCODE_MAX_MASS=(1.5e-7)
...
#ADAPTIVE_GRAVSOFT_FORALL=2   # enable adaptive gravitational softening lengths for designated particle types (ADAPTIVE_GRAVSOFT_FORGAS should be disabled). the softening is set to the distance
